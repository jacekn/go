...
type SellingBuyingAssetQueryParams struct {
	SellingAssetType   string `schema:"selling_asset_type" valid:"assetType"`
	SellingAssetIssuer string `schema:"selling_asset_issuer" valid:"accountID"`
	SellingAssetCode   string `schema:"selling_asset_code" valid:"sellingCode"`
	...
	BuyingAssetCode    string `schema:"buying_asset_code" valid:"buyingCode"`
}
